...
source_directory = 'data/processed/resized_gameplay/'
target_directory1 = 'data/processed/train_images/not_cars/'
target_directory2 = 'data/processed/val_images/not_cars/'
